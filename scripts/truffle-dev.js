StakingRewardsToken.deployed().then(function(instance){return instance.mintTo('0xe53f6952f7fa230755935ebbb8cb9124623ff0b4', parseInt(Date.now() / 1000) +100, 1586945100, '', 1, '', 0);});
...
StakingRewardsToken.deployed().then(function(instance){return instance.updateAds();});
